...
// DONE: moveDown, moveRight, moveLeft are almost idencial. please refactor
  this.move = (direction) => {
    switch(direction) {
      case RIGHT: {this.x++; this.render(); break;}
      case LEFT: {this.x--; this.render(); break;}
      case DOWN: {this.y--; this.render(); break;}
    }
  }
